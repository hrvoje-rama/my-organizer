...
const todoInputButtonSecond = document.querySelector(".submit-second");
...
todoInputButtonSecond.addEventListener("click", validateForm);
...
function addTodo(){
    ...
    /*checkButton.innerHTML = '<i class="fas fa-check check" alt="check-icon"></i>';*/
    ...
    /*deleteButton.innerHTML = '<i class="fas fa-trash-alt" alt="delete"></i>';*/
